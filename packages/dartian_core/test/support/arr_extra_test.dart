...
void main() {
  group('Arr Extra', () {
      ...
      test('crossJoin', () {
          expect(Arr.crossJoin([[1, 2], ['a', 'b']]), [[1, 'a'], [1, 'b'], [2, 'a'], [2, 'b']]);
      });
      ...
      test('keyBy', () {
          final list = [{'id': 1, 'name': 'A'}, {'id': 2, 'name': 'B'}];
      ...
      test('map/mapSpread/mapWithKeys', () {
           ...
           // mapSpread
           expect(Arr.mapSpread([[1], [2, 3]], (e) => e), [1, 2, 3]);
           // mapWithKeys
      ...
      test('toCssClasses', () {
          ...
          expect(Arr.toCssClasses([{'a': true}, 'b']), 'a b');
      });
